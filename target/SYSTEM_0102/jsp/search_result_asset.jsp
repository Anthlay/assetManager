        ...
        <section class="content"> <!-- .box-body -->
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">固定资产搜索结果</h3>
                </div>
                ...
                <div class="box-body">
                    ...
                    <div class="table-box">
                        ...
                        <table id="dataList"
                            ...
                            <tbody>
                            <c:forEach var="asset_search" items="${asset_search.list}">
                                <tr>
                                    <td>${asset_search.assetId}</td>
                                    <td>${asset_search.assetName}</td>
                                    <td>${asset_search.assetCount}</td>
                                    <td>${asset_search.assetPrice}</td>
                                    <td>${asset_search.assetAddress}</td>
                                    <td>${asset_search.assetOperator}</td>
                                    <td class="text-center">
                                        <a href="/asset/toupdateAsset.do?id=${asset_search.assetId}" class="btn bg-olive btn-xs">更新</a>
                                        <a href="/asset/deleteAsset.do?assetId=${asset_search.assetId}" class="btn bg-olive btn-xs">删除</a>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
                ...
                <div class="box-tools pull-right">
                    <ul class="pagination">
                        ...
                        <c:forEach begin="1" end = "${asset_search.pages}" var="pageNum">
