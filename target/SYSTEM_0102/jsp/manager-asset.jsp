            ...
            <div class="left-nav">
                ...
                <div class="list-box">
                    ...
                    <dl>
                        ...
                        <dd><a href="${pageContext.request.contextPath}/operator/findAll.do">操作员管理</a></dd>
                    </dl>
                                ...
                                <div class="row">
                                        ...
                                        <ul class="searchform">       
                                            <li>
                                                <form action="${pageContext.request.contextPath}/asset/findAssetByName.do"
                                                      method="post">
                                                    <input type="text" name="goodsName" placeholder="根据商品名字查询"
                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <div class="box-tools pull-left">
                                            <ul class="pagination">
                                                <li>
                                                    <a href="${pageContext.request.contextPath}/fillAllAsset.do?page=1&size=5"
                                                       aria-label="Previous">首页</a></li>
                                                <li>
                                                    <a href="${pageContext.request.contextPath}/fillAllAsset.do?page=${pageInfo.pageNum-1}&size=5">上一页</a>
                                                </li>
                                                <c:forEach begin="1" end="${pageInfo.pages}" var="pageNum">
                                                    <li>
                                                        <a href="${pageContext.request.contextPath}/fillAllAsset.do?page=${pageNum}&size=5">${pageNum}</a>
                                                    </li>
                                                </c:forEach>
                                                <li>
                                                    <a href="${pageContext.request.contextPath}/fillAllAsset.do?page=${pageInfo.pageNum+1}&size=5">下一页</a>
                                                </li>
                                                <li>
                                                    <a href="${pageContext.request.contextPath}/fillAllAsset.do?page=${pageInfo.pages}&size=5"
